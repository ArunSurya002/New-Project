	...
	public static void main(String[] args) throws InterruptedException, AWTException, IOException {
		...
		driver.manage().window().maximize();
		 ...
		 Actions acc=new Actions(driver);
			acc.moveToElement(link).perform();
			WebElement oracle=driver.findElement(By.xpath("//span[contains(text(),'Oracle Training')]"));
			acc.moveToElement(oracle).perform();
			Thread.sleep(1000);
			WebElement sql=driver.findElement(By.xpath("//span[contains(text(),'Oracle SQL and PLSQL Placement Training')]"));
		        acc.contextClick(sql).perform();
		        Robot r= new Robot();
				...
				r.keyRelease(KeyEvent.VK_ENTER);
				 Set<String> all = driver.getWindowHandles();
					...
					File d=new File("C:\\Users\\user\\Downloads\\org\\out2.png");
